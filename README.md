...
- **Knowledge Base Construction:** Structured RFM features and Churn Risk scores are serialized into semantically dense narratives. This allows the Gemini embedding model to capture the relationship between a customer's 'High Risk' status and their 'Frequency' of purchase, which a simple keyword search would miss
