...
Customer churn remains a critical challenge for subscription-based businesses, and while traditional predictive models identify at-risk customers, they often fail to provide the qualitative context necessary for effective, personalized intervention. To bridge this gap, I developed an end-to-end decision-support system that integrates predictive churn modeling with Retrieval-Augmented Generation (RAG). I engineered an automated pipeline utilizing Python, Gemini, and ChromaDB to synthesize structured customer behavior metrics with unstructured support feedback and interaction logs. By transforming raw historical data into context-aware, actionable retention intelligence, this engine enables stakeholders to deploy proactive, highly personalized engagement strategies, successfully converting static churn scores into dynamic insights that drive measurable improvements in long-term customer retention.
